...
class DBWNode(object):
    def __init__(self):
        ...
        self.curr_velocity_sub = rospy.Subscriber('/current_velocity',TwistStamped, self.velocity_cb)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            throttle, brake, steer = self.controller.control(self.current_velocity,
                                                             self.dbw_enabled,
                                                             self.linear_vel,
                                                             self.angular_vel)
            if self.dbw_enabled:
